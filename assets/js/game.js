...
//can aslso log multiple values at once: console.log(playerName, playerAttack, playerHealth);
...
var startGame = function(){ 
  ...
  for(var i = 0; i < enemyNames.length; i++) {
    if (playerHealth > 0) {
     ...
     // reset enemyHealth before starting new fight-- result will return a whole number between 20 and 60
